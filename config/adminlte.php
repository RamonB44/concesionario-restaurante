...
return [
    ...
    */
    ...
    'logo' => '<b>Concesionario</b>Beta',
    'logo_img' => 'vendor/adminlte/dist/img/AdminLTELogo.png',
    'logo_img_class' => 'brand-image-xl',
    'logo_img_xl' => null,
    'logo_img_xl_class' => 'brand-image-xs',
    'logo_img_alt' => 'Concesionario',
    ...
    */
    ...
    'plugins' => [
        ...
        [
            'name' => 'DataRangePickerJs',
            'active' => false,
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'daterangepicker/moment.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'daterangepicker/daterangepicker.js',
                ],
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => 'daterangepicker/daterangepicker.css',
                ],
            ],
        ],
        [
